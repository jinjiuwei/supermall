...
<!--      <el-form-item
        ...
        label="手机号"
        >
        <el-input placeholder="请输入手机号" prefix-icon="el-icon-phone" v-model="form.phone" clearable></el-input>
      </el-form-item>
      <el-form-item
        label="验证码"
        prop="verification"
        >
        <el-input placeholder="请输入验证码" type="text" prefix-icon="el-icon-warning-outline" clearable v-model="form.verification"></el-input>
      </el-form-item>-->
      <el-form-item>
        <el-button type="primary" @click="submitForm('ResForm')">注册</el-button>
